...
function spwanobstacles(){
  if (frameCount % 60 === 0) {
    obstacles = createSprite(400,165,40,10);
    var rand=Math.round(random(1,6));
    switch(rand){
      case 1:obstacles.addImage(obstacles1);break
      case 2:obstacles.addImage(obstacles2);break
      case 3:obstacles.addImage(obstacles3);break
      case 4:obstacles.addImage(obstacles4);break
      case 5:obstacles.addImage(obstacles5);break
      case 6:obstacles.addImage(obstacles6);break
    }
